...
SECRET_KEY = 'django-insecure-kv=a5%!(u(p*ky(%d)yaobim!fvqa8cv&l1b=^a0=m9-v8)zqq'
...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '.railway.app', # This allows any domain generated by Railway
]
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST') or os.getenv('PGHOST', '127.0.0.1'), # Prevents empty local socket fallback
